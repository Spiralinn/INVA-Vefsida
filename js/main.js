// DOMContentLoaded — bíður eftir að HTML sé fullhlaðið
// áður en JavaScript reynir að finna element á síðunni
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (sambandsform && formStadfesting) {
